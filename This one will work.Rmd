...
#remember to not run this more than once
training <- fold(
  training,
  k = 10,
  cat_col = "diagnosis",
...
#Scaling and standardizing for training and test respectively using caret
...
CV <- cross_validate(
  data = training,
  formulas = c("diagnosis ~ pots + sd",
               "diagnosis ~ pots + pause_dur + sd",
               "diagnosis ~ iqr",
               "diagnosis ~ sd",
               "diagnosis ~ pots",
               "diagnosis ~ pause_dur"),
